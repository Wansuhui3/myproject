...
模块依赖方向（避免循环导入）：
  wave_callbacks        → helpers
  comparison_callbacks  → helpers
  performance_callbacks → helpers + comparison_callbacks
...
from .comparison_callbacks import (  # noqa: F401
...
from .wave_callbacks import (  # noqa: F401
